...
public interface MCVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link MCParser#nullable_list_of_param}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNullable_list_of_param(MCParser.Nullable_list_of_paramContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link MCParser#list_of_param}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitList_of_param(MCParser.List_of_paramContext ctx);
	/**
